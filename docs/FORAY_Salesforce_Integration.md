...
| Contact | ðŸ”„ Planned | Future release | |
| Custom Objects | ðŸ”„ Planned | Future release | |

### ⚠️ Important: Case Object Handling
...
// These are ESTIMATES, not Salesforce fields:
{
  ...
  estimated_cost: 800           // hours × $100/hour (configurable)
}
```
...
| Amount × Probability | Accrual | Expected revenue (obfuscated) |
...
Risk-Adjusted = Expected Revenue × 0.85 (15% haircut)
```
