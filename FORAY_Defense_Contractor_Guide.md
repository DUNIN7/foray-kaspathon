...
DCAA auditors canâ€”and doâ€”question any transaction. The burden of proof falls on the contractor.
...
If questioned two years later, the anchor proves the charge was recorded at the time claimedâ€”not reconstructed for audit.
...
The blockchain anchor proves when an unallowable cost was identifiedâ€”not when you said you identified it.
...
```
Prime anchors subcontract â†’ Sub anchors invoices â†’ Prime verifies before payment
```
...
When every transaction is anchored at the time it occurs, "knowing" mischarging becomes much harder to allegeâ€”and easier to disprove.
...
**`manufacturing-work-order-v41.json`** â€” Production work order with:
- Direct material and labor allocation
- Overhead absorption
- Cost variance settlement

**`batch-payment-v41.json`** â€” Payment processing with:
...
### Audit Engagement
Consider briefing your DCAA auditor on FORAY implementationâ€”they may welcome the improved audit evidence.
